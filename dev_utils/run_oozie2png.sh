...
do
	...
	export PYTHONPATH=$MY_PYTHON_PATH:$MY_CURR_DIR; cat $WORKFLOW_PATH | ./scripts/vipe-oozie2png --detail_level $DETAIL_LEVEL --horizontal_orientation --show_input_ports --show_output_ports > ${OUTPUT_PATH_PREFIX}-${i}_${DETAIL_LEVEL}_detail.png
done
